...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="index_user.php">Home</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <a class="navbar-brand" href="tambahartikel.php">Tambah Artikel</a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon"></span>
        </button>
        <li class="nav-item">
                       ...
                       ?>
                           <div class="card col-6 " style="width: 18rem;">
                             <img  src="file_cover/<?php echo $row['cover'] ?>"    width="250">
                               ...
                               <div class="card-body">
                                 <a href="lihatlebih_user.php?id=<?php echo $row['id']?>" class="btn btn-primary btn-sm w-75">lihat lebih</a>
                               </div>
                          </div>
                         <?php 
                         $nomor++;
...
<!-- isi artikel -->
  ...
  <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <form action="proses_komentar_user.php" method="post">
                            <div class="mb-3">
                           ...
                           <div class="col-sm-12">
                              <ul class="list-unstyled mb-0">
                                ...
                                while ($kategori = $kategori_result->fetch_assoc()) {
                                    ?>
                                    <li>
                                        <a href="detailkategori_user.php?id=<?php echo $kategori['id']; ?>">
